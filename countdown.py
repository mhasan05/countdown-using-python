...
### Get user input
hourTextbox = Entry(clockWindow, width=3, font=("Calibri", 25, ""), textvariable=hourString)
minuteTextbox = Entry(clockWindow, width=3, font=("Calibri", 25, ""), textvariable=minuteString)
secondTextbox = Entry(clockWindow, width=3, font=("Calibri", 25, ""), textvariable=secondString)
...
setTimeButton = Button(clockWindow, text='Set Time', bd='4', command=runTimer)
